...
{
    ArrayList<OrderlineDTO> theDTOs;
    ...
    public OrderDetailsAdapter(Context context, Context context2, ArrayList<OrderlineDTO> theDTOs)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        OrderlineDTO theDTO = theDTOs.get(position);
